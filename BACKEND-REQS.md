...
so that a deployment tool such as Basalt can start it beside the
others.  The wrapper itself never pulls or starts a container; it
connects to one that is already running:
